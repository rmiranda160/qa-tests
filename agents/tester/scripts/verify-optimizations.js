...
const SITE_URL = 'https://cntai.cenarbe.com';
 ...
 */
async function main() {
  console.log('Iniciando verificación de optimizaciones para ContentoAI');
  ...
  try {
    ...
    console.log('\nNota: Para testing de performance (Lighthouse), ejecutar manualmente:');
    console.log('npx lighthouse https://cntai.cenarbe.com --output=json --output-path=report.json');
  } catch (error) {
