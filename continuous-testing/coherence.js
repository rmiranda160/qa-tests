...
async function main() {
  console.log('🚀 Starting coherence cycle for all applications');
  ...
  const resultsFile = path.join(RESULTS_DIR, `coherence-cycle-${cycleId}.json`);
  ...
  if (criticalErrors) {
    ...
    const alertFile = path.join(RESULTS_DIR, `coherence-alert-${cycleId}.json`);
